...
class ValidationMessage(BaseModel):
    ...
    type: Annotated[
        ...
        Field(title="cloudcoil.models.istio.security.v1beta1.MessageType"),
    ] = None
...
class AuthorizationPolicy(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(self, value: Optional[Literal["security.istio.io/v1beta1"]], /) -> Self:
    ...
    api_version: Annotated[
        Optional[Literal["security.istio.io/v1beta1"]], Field(alias="apiVersion")
