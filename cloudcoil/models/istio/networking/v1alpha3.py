...
class ValidationMessage(BaseModel):
    ...
    type: Annotated[
        ...
        Field(title="cloudcoil.models.istio.networking.v1alpha3.MessageType"),
    ] = None
...
class Cluster(BaseModel):
    ...
    The exact name of the cluster to match.
    """
    port_number: Annotated[Optional[int], Field(alias="portNumber", ge=0, le=4294967295)] = None
    """
    The service port for which this cluster was generated.
    """
...
class SubFilter(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["SubFilter"]:
            return SubFilter

        def build(self) -> "SubFilter":
            return SubFilter(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["SubFilter.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = SubFilter.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for SubFilter."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["SubFilter", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use SubFilter.list_builder() instead."
            )
...
class Filter(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def sub_filter(self, value_or_callback: Optional[SubFilter], /) -> "Filter.Builder": ...

        @overload
        def sub_filter(
            self,
            value_or_callback: Callable[[SubFilter.Builder], SubFilter.Builder | SubFilter],
            /,
        ) -> "Filter.Builder": ...

        @overload
        def sub_filter(self, value_or_callback: Never = ...) -> "SubFilter.BuilderContext": ...

        def sub_filter(self, value_or_callback=None, /):
            """
            The next level filter within this filter to match upon.
            """
            if self._in_context and value_or_callback is None:
                context = SubFilter.BuilderContext()
                context._parent_builder = self
                context._field_name = "sub_filter"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(SubFilter.builder())
                if isinstance(output, SubFilter.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("sub_filter", value)
    ...
    The filter name to match on.
    """
    sub_filter: Annotated[Optional[SubFilter], Field(alias="subFilter")] = None
    """
    The next level filter within this filter to match upon.
    """
...
class FilterChain(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["FilterChain"]:
            return FilterChain

        def build(self) -> "FilterChain":
            return FilterChain(**self._attrs)

        def application_protocols(self, value: Optional[str], /) -> Self:
            """
            Applies only to sidecars.
            """
            return self._set("application_protocols", value)

        def destination_port(self, value: Optional[int], /) -> Self:
            """
            The destination_port value used by a filter chain's match condition.
            """
            return self._set("destination_port", value)

        @overload
        def filter(self, value_or_callback: Optional[Filter], /) -> "FilterChain.Builder": ...
        ...
        def transport_protocol(self, value: Optional[str], /) -> Self:
            """
            Applies only to `SIDECAR_INBOUND` context.
            """
            return self._set("transport_protocol", value)

    class BuilderContext(BuilderContextBase["FilterChain.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = FilterChain.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for FilterChain."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["FilterChain", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use FilterChain.list_builder() instead."
            )
    ...
    application_protocols: Annotated[Optional[str], Field(alias="applicationProtocols")] = None
    """
    Applies only to sidecars.
    """
    destination_port: Annotated[
        Optional[int], Field(alias="destinationPort", ge=0, le=4294967295)
    ] = None
    """
    The destination_port value used by a filter chain's match condition.
    """
    ...
    The SNI value used by a filter chain's match condition.
    """
    transport_protocol: Annotated[Optional[str], Field(alias="transportProtocol")] = None
    """
    Applies only to `SIDECAR_INBOUND` context.
    """
...
class Listener(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Listener"]:
            return Listener

        def build(self) -> "Listener":
            return Listener(**self._attrs)

        @overload
        def filter_chain(
            self, value_or_callback: Optional[FilterChain], /
        ) -> "Listener.Builder": ...

        @overload
        def filter_chain(
            self,
            value_or_callback: Callable[[FilterChain.Builder], FilterChain.Builder | FilterChain],
            /,
        ) -> "Listener.Builder": ...

        @overload
        def filter_chain(self, value_or_callback: Never = ...) -> "FilterChain.BuilderContext": ...

        def filter_chain(self, value_or_callback=None, /):
            """
            Match a specific filter chain in a listener.
            """
            if self._in_context and value_or_callback is None:
                context = FilterChain.BuilderContext()
                context._parent_builder = self
                context._field_name = "filter_chain"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(FilterChain.builder())
                if isinstance(output, FilterChain.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("filter_chain", value)

        def listener_filter(self, value: Optional[str], /) -> Self:
            """
            Match a specific listener filter.
            """
            return self._set("listener_filter", value)
    ...
    class BuilderContext(BuilderContextBase["Listener.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Listener.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Listener."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Listener", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Listener.list_builder() instead."
            )
    ...
    filter_chain: Annotated[Optional[FilterChain], Field(alias="filterChain")] = None
    """
    Match a specific filter chain in a listener.
    """
    listener_filter: Annotated[Optional[str], Field(alias="listenerFilter")] = None
    """
    Match a specific listener filter.
    """
    name: Optional[str] = None
    ...
    Match a specific listener by its name.
    """
    port_name: Annotated[Optional[str], Field(alias="portName")] = None
    port_number: Annotated[Optional[int], Field(alias="portNumber", ge=0, le=4294967295)] = None
    """
    The service port/gateway port to which traffic is being sent/received.
    """
...
class Proxy(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Proxy"]:
            return Proxy

        def build(self) -> "Proxy":
            return Proxy(**self._attrs)
        ...
        def proxy_version(self, value: Optional[str], /) -> Self:
            """
            ...
            """
            return self._set("proxy_version", value)

    class BuilderContext(BuilderContextBase["Proxy.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Proxy.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Proxy."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Proxy", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Proxy.list_builder() instead."
            )
    ...
    Match on the node metadata supplied by a proxy when connecting to Istio Pilot.
    """
    proxy_version: Annotated[Optional[str], Field(alias="proxyVersion")] = None
    """
    A regular expression in golang regex format (RE2) that can be used to select proxies using a specific version of istio proxy.
    """
...
class Route(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def action(
            self,
            value: Optional[Literal["ANY", "ROUTE", "REDIRECT", "DIRECT_RESPONSE"]],
            /,
        ) -> Self:
            """
    ...
    action: Optional[Literal["ANY", "ROUTE", "REDIRECT", "DIRECT_RESPONSE"]] = None
    """
    Match a route with specific action type.
...
class Vhost(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["Vhost"]:
            return Vhost

        def build(self) -> "Vhost":
            return Vhost(**self._attrs)
        ...
        @overload
        def route(self, value_or_callback: Optional[Route], /) -> "Vhost.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["Vhost.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = Vhost.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for Vhost."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["Vhost", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use Vhost.list_builder() instead."
            )
...
class RouteConfiguration(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["RouteConfiguration"]:
            return RouteConfiguration

        def build(self) -> "RouteConfiguration":
            return RouteConfiguration(**self._attrs)

        def gateway(self, value: Optional[str], /) -> Self:
            """
        ...
        @overload
        def vhost(self, value_or_callback: Optional[Vhost], /) -> "RouteConfiguration.Builder": ...

        @overload
        def vhost(
            self, value_or_callback: Callable[[Vhost.Builder], Vhost.Builder | Vhost], /
        ) -> "RouteConfiguration.Builder": ...

        @overload
        def vhost(self, value_or_callback: Never = ...) -> "Vhost.BuilderContext": ...

        def vhost(self, value_or_callback=None, /):
            """
            Match a specific virtual host in a route configuration and apply the patch to the virtual host.
            """
            if self._in_context and value_or_callback is None:
                context = Vhost.BuilderContext()
                context._parent_builder = self
                context._field_name = "vhost"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Vhost.builder())
                if isinstance(output, Vhost.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("vhost", value)

    class BuilderContext(BuilderContextBase["RouteConfiguration.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = RouteConfiguration.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for RouteConfiguration."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["RouteConfiguration", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use RouteConfiguration.list_builder() instead."
            )
...
class Match(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def cluster(self, value_or_callback: Optional[Cluster], /) -> "Match.Builder": ...

        @overload
        def cluster(
            self,
            value_or_callback: Callable[[Cluster.Builder], Cluster.Builder | Cluster],
            /,
        ) -> "Match.Builder": ...

        @overload
        def cluster(self, value_or_callback: Never = ...) -> "Cluster.BuilderContext": ...

        def cluster(self, value_or_callback=None, /):
            """
            Match on envoy cluster attributes.
            """
            if self._in_context and value_or_callback is None:
                context = Cluster.BuilderContext()
                context._parent_builder = self
                context._field_name = "cluster"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Cluster.builder())
                if isinstance(output, Cluster.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("cluster", value)

        def context(
            self,
            value: Optional[Literal["ANY", "SIDECAR_INBOUND", "SIDECAR_OUTBOUND", "GATEWAY"]],
            /,
        ) -> Self:
            """
        ...
        @overload
        def listener(self, value_or_callback: Optional[Listener], /) -> "Match.Builder": ...

        @overload
        def listener(
            self,
            value_or_callback: Callable[[Listener.Builder], Listener.Builder | Listener],
            /,
        ) -> "Match.Builder": ...

        @overload
        def listener(self, value_or_callback: Never = ...) -> "Listener.BuilderContext": ...

        def listener(self, value_or_callback=None, /):
            """
            Match on envoy listener attributes.
            """
            if self._in_context and value_or_callback is None:
                context = Listener.BuilderContext()
                context._parent_builder = self
                context._field_name = "listener"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Listener.builder())
                if isinstance(output, Listener.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("listener", value)

        @overload
        def proxy(self, value_or_callback: Optional[Proxy], /) -> "Match.Builder": ...

        @overload
        def proxy(
            self, value_or_callback: Callable[[Proxy.Builder], Proxy.Builder | Proxy], /
        ) -> "Match.Builder": ...

        @overload
        def proxy(self, value_or_callback: Never = ...) -> "Proxy.BuilderContext": ...

        def proxy(self, value_or_callback=None, /):
            """
            Match on properties associated with a proxy.
            """
            if self._in_context and value_or_callback is None:
                context = Proxy.BuilderContext()
                context._parent_builder = self
                context._field_name = "proxy"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Proxy.builder())
                if isinstance(output, Proxy.Builder):
                    value = output.build()
                else:
                    value = output
        ...
        def route_configuration(
            self, value_or_callback: Optional[RouteConfiguration], /
        ) -> "Match.Builder": ...
        ...
        def route_configuration(
            ...
            value_or_callback: Callable[
                [RouteConfiguration.Builder],
                RouteConfiguration.Builder | RouteConfiguration,
            ],
            /,
        ) -> "Match.Builder": ...
        ...
        def route_configuration(
            self, value_or_callback: Never = ...
        ) -> "RouteConfiguration.BuilderContext": ...

        def route_configuration(self, value_or_callback=None, /):
            """
            Match on envoy HTTP route configuration attributes.
            """
            if self._in_context and value_or_callback is None:
                context = RouteConfiguration.BuilderContext()
                context._parent_builder = self
                context._field_name = "route_configuration"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(RouteConfiguration.builder())
                if isinstance(output, RouteConfiguration.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("route_configuration", value)
    ...
    Match on envoy cluster attributes.
    """
    context: Optional[Literal["ANY", "SIDECAR_INBOUND", "SIDECAR_OUTBOUND", "GATEWAY"]] = None
    """
    The specific config generation context to match on.
    ...
    Match on properties associated with a proxy.
    """
    route_configuration: Annotated[
        Optional[RouteConfiguration], Field(alias="routeConfiguration")
    ] = None
    """
    Match on envoy HTTP route configuration attributes.
    """
...
class MatchModel(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def cluster(self, value_or_callback: Optional[Cluster], /) -> "MatchModel.Builder": ...
        ...
        @overload
        def listener(self, value_or_callback: Listener, /) -> "MatchModel.Builder": ...
        ...
        @overload
        def proxy(self, value_or_callback: Optional[Proxy], /) -> "MatchModel.Builder": ...
...
class MatchModel1(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def cluster(self, value_or_callback: Optional[Cluster], /) -> "MatchModel1.Builder": ...
        ...
        @overload
        def listener(self, value_or_callback: Optional[Listener], /) -> "MatchModel1.Builder": ...
        ...
        @overload
        def proxy(self, value_or_callback: Optional[Proxy], /) -> "MatchModel1.Builder": ...
        ...
        @overload
        def route_configuration(
            self, value_or_callback: RouteConfiguration, /
        ) -> "MatchModel1.Builder": ...
    ...
    Match on properties associated with a proxy.
    """
    route_configuration: Annotated[RouteConfiguration, Field(alias="routeConfiguration")]
    """
    Match on envoy HTTP route configuration attributes.
    """
...
class MatchModel2(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def cluster(self, value_or_callback: Cluster, /) -> "MatchModel2.Builder": ...
        ...
        @overload
        def listener(self, value_or_callback: Optional[Listener], /) -> "MatchModel2.Builder": ...
        ...
        @overload
        def proxy(self, value_or_callback: Optional[Proxy], /) -> "MatchModel2.Builder": ...
...
class Patch(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        def filter_class(
            self, value: Optional[Literal["UNSPECIFIED", "AUTHN", "AUTHZ", "STATS"]], /
        ) -> Self:
            """
            ...
            """
            return self._set("filter_class", value)
        ...
        def value(self, value: Optional[Dict[str, Any]], /) -> Self:
            """
    ...
    filter_class: Annotated[
        Optional[Literal["UNSPECIFIED", "AUTHN", "AUTHZ", "STATS"]],
        Field(alias="filterClass"),
    ] = None
    """
    Determines the filter insertion order.
...
class ConfigPatch(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["ConfigPatch"]:
            return ConfigPatch

        def build(self) -> "ConfigPatch":
            return ConfigPatch(**self._attrs)
        ...
        def apply_to(
            ...
            """
            return self._set("apply_to", value)

        def match(
            self, value: Optional[Union[Match, MatchModel, MatchModel1, MatchModel2]], /
        ) -> Self:
            """
        ...
        @overload
        def patch(self, value_or_callback: Optional[Patch], /) -> "ConfigPatch.Builder": ...

        @overload
        def patch(
            self, value_or_callback: Callable[[Patch.Builder], Patch.Builder | Patch], /
        ) -> "ConfigPatch.Builder": ...

        @overload
        def patch(self, value_or_callback: Never = ...) -> "Patch.BuilderContext": ...
        ...
        def patch(self, value_or_callback=None, /):
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(Patch.builder())
                if isinstance(output, Patch.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("patch", value)

    class BuilderContext(BuilderContextBase["ConfigPatch.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = ConfigPatch.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for ConfigPatch."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["ConfigPatch", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use ConfigPatch.list_builder() instead."
            )
    ...
    Valid Options: LISTENER, FILTER_CHAIN, NETWORK_FILTER, HTTP_FILTER, ROUTE_CONFIGURATION, VIRTUAL_HOST, HTTP_ROUTE, CLUSTER, EXTENSION_CONFIG, BOOTSTRAP, LISTENER_FILTER
    """
    match: Optional[Union[Match, MatchModel, MatchModel1, MatchModel2]] = None
    """
    Match on listener/route configuration/cluster.
    """
...
class EnvoyFilterSpec(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["EnvoyFilterSpec"]:
            return EnvoyFilterSpec

        def build(self) -> "EnvoyFilterSpec":
            return EnvoyFilterSpec(**self._attrs)

        @overload
        def config_patches(
            self, value_or_callback: List[ConfigPatch], /
        ) -> "EnvoyFilterSpec.Builder": ...

        @overload
        def config_patches(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[ConfigPatch, ConfigPatch.Builder]],
                GenericListBuilder[ConfigPatch, ConfigPatch.Builder] | List[ConfigPatch],
            ],
            /,
        ) -> "EnvoyFilterSpec.Builder": ...
        ...
        def config_patches(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[ConfigPatch.Builder]: ...

        def config_patches(self, value_or_callback=None, /):
            """
            One or more patches with match conditions.
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[ConfigPatch.Builder]()
                context._parent_builder = self
                context._field_name = "config_patches"
                return context

            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(ConfigPatch.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
            return self._set("config_patches", value)
    ...
    class BuilderContext(BuilderContextBase["EnvoyFilterSpec.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = EnvoyFilterSpec.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for EnvoyFilterSpec."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["EnvoyFilterSpec", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use EnvoyFilterSpec.list_builder() instead."
            )
    ...
    config_patches: Annotated[Optional[List[ConfigPatch]], Field(alias="configPatches")] = None
    """
    One or more patches with match conditions.
    """
...
class EnvoyFilterStatus(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["EnvoyFilterStatus"]:
            return EnvoyFilterStatus

        def build(self) -> "EnvoyFilterStatus":
            return EnvoyFilterStatus(**self._attrs)

        @overload
        def conditions(
            self, value_or_callback: List[Condition], /
        ) -> "EnvoyFilterStatus.Builder": ...
    ...
    class BuilderContext(BuilderContextBase["EnvoyFilterStatus.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = EnvoyFilterStatus.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for EnvoyFilterStatus."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["EnvoyFilterStatus", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use EnvoyFilterStatus.list_builder() instead."
            )
...
class RouteModel(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def headers(
            self, value_or_callback: Optional[HeadersModel4], /
        ) -> "RouteModel.Builder": ...
...
class HttpModel(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def match(self, value_or_callback: List[MatchModel3], /) -> "HttpModel.Builder": ...

        @overload
        def match(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[MatchModel3, MatchModel3.Builder]],
                GenericListBuilder[MatchModel3, MatchModel3.Builder] | List[MatchModel3],
            ],
            /,
        ) -> "HttpModel.Builder": ...
        ...
        def match(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[MatchModel3.Builder]: ...
        ...
        def match(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[MatchModel3.Builder]()
                context._parent_builder = self
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(MatchModel3.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def route(self, value_or_callback: List[RouteModel], /) -> "HttpModel.Builder": ...
    ...
    match: Optional[List[MatchModel3]] = None
    """
    Match conditions to be satisfied for the rule to be activated.
    """
...
class MatchModel4(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["MatchModel4"]:
            return MatchModel4

        def build(self) -> "MatchModel4":
            return MatchModel4(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["MatchModel4.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = MatchModel4.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for MatchModel4."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["MatchModel4", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use MatchModel4.list_builder() instead."
            )
...
class RouteModel1(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def destination(self, value_or_callback: Destination, /) -> "RouteModel1.Builder": ...
...
class TcpModel(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def match(self, value_or_callback: List[MatchModel4], /) -> "TcpModel.Builder": ...

        @overload
        def match(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[MatchModel4, MatchModel4.Builder]],
                GenericListBuilder[MatchModel4, MatchModel4.Builder] | List[MatchModel4],
            ],
            /,
        ) -> "TcpModel.Builder": ...
        ...
        def match(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[MatchModel4.Builder]: ...
        ...
        def match(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[MatchModel4.Builder]()
                context._parent_builder = self
                context._field_name = "match"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(MatchModel4.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def route(self, value_or_callback: List[RouteModel1], /) -> "TcpModel.Builder": ...
    ...
    match: Optional[List[MatchModel4]] = None
    """
    Match conditions to be satisfied for the rule to be activated.
    """
    route: Optional[List[RouteModel1]] = None
    """
    The destination to which the connection should be forwarded to.
    """


class MatchModel5(BaseModel):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["MatchModel5"]:
            return MatchModel5

        def build(self) -> "MatchModel5":
            return MatchModel5(**self._attrs)
    ...
    class BuilderContext(BuilderContextBase["MatchModel5.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = MatchModel5.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for MatchModel5."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["MatchModel5", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use MatchModel5.list_builder() instead."
            )
...
class Tl(BaseModel):
    class Builder(BaseModelBuilder):
        ...
        @overload
        def match(self, value_or_callback: List[MatchModel5], /) -> "Tl.Builder": ...

        @overload
        def match(
            self,
            value_or_callback: Callable[
                [GenericListBuilder[MatchModel5, MatchModel5.Builder]],
                GenericListBuilder[MatchModel5, MatchModel5.Builder] | List[MatchModel5],
            ],
            /,
        ) -> "Tl.Builder": ...
        ...
        def match(
            self, value_or_callback: Never = ...
        ) -> ListBuilderContext[MatchModel5.Builder]: ...
        ...
        def match(self, value_or_callback=None, /):
            ...
            """
            if self._in_context and value_or_callback is None:
                context = ListBuilderContext[MatchModel5.Builder]()
                context._parent_builder = self
                context._field_name = "match"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(MatchModel5.list_builder())
                if isinstance(output, GenericListBuilder):
                    value = output.build()
                else:
                    value = output
        ...
        @overload
        def route(self, value_or_callback: List[RouteModel1], /) -> "Tl.Builder": ...
...
class DestinationRule(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(self, value: Optional[Literal["networking.istio.io/v1alpha3"]], /) -> Self:
    ...
    api_version: Annotated[
        Optional[Literal["networking.istio.io/v1alpha3"]], Field(alias="apiVersion")
    ] = "networking.istio.io/v1alpha3"
    kind: Optional[Literal["DestinationRule"]] = "DestinationRule"
    metadata: Optional[apimachinery.ObjectMeta] = None


class EnvoyFilter(Resource):
    class Builder(BaseModelBuilder):
        @property
        def cls(self) -> Type["EnvoyFilter"]:
            return EnvoyFilter

        def build(self) -> "EnvoyFilter":
            return EnvoyFilter(**self._attrs)

        @overload
        def spec(
            self, value_or_callback: Optional[EnvoyFilterSpec], /
        ) -> "EnvoyFilter.Builder": ...
        ...
        def spec(
            self,
            value_or_callback: Callable[
                [EnvoyFilterSpec.Builder], EnvoyFilterSpec.Builder | EnvoyFilterSpec
            ],
            /,
        ) -> "EnvoyFilter.Builder": ...

        @overload
        def spec(self, value_or_callback: Never = ...) -> "EnvoyFilterSpec.BuilderContext": ...

        def spec(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = EnvoyFilterSpec.BuilderContext()
                context._parent_builder = self
                context._field_name = "spec"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(EnvoyFilterSpec.builder())
                if isinstance(output, EnvoyFilterSpec.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("spec", value)
        ...
        @overload
        def status(
            self, value_or_callback: Optional[EnvoyFilterStatus], /
        ) -> "EnvoyFilter.Builder": ...
        ...
        def status(
            ...
            value_or_callback: Callable[
                [EnvoyFilterStatus.Builder],
                EnvoyFilterStatus.Builder | EnvoyFilterStatus,
            ],
            /,
        ) -> "EnvoyFilter.Builder": ...

        @overload
        def status(self, value_or_callback: Never = ...) -> "EnvoyFilterStatus.BuilderContext": ...

        def status(self, value_or_callback=None, /):
            if self._in_context and value_or_callback is None:
                context = EnvoyFilterStatus.BuilderContext()
                context._parent_builder = self
                context._field_name = "status"
                return context
            ...
            value = value_or_callback
            if callable(value_or_callback):
                output = value_or_callback(EnvoyFilterStatus.builder())
                if isinstance(output, EnvoyFilterStatus.Builder):
                    value = output.build()
                else:
                    value = output
            return self._set("status", value)
        ...
        def kind(self, value: Optional[Literal["EnvoyFilter"]], /) -> Self:
            return self._set("kind", value)
    ...
    class BuilderContext(BuilderContextBase["EnvoyFilter.Builder"]):
        def model_post_init(self, __context) -> None:
            self._builder = EnvoyFilter.Builder()
            self._builder._in_context = True
            self._parent_builder = None
            self._field_name = None
    ...
    @classmethod
    def new(cls) -> BuilderContext:
        """Creates a new context manager builder for EnvoyFilter."""
        return cls.BuilderContext()

    class ListBuilder(GenericListBuilder["EnvoyFilter", Builder]):
        def __init__(self):
            raise NotImplementedError(
                "This class is not meant to be instantiated. Use EnvoyFilter.list_builder() instead."
            )
    ...
    status: Optional[EnvoyFilterStatus] = None
    api_version: Annotated[
        Optional[Literal["networking.istio.io/v1alpha3"]], Field(alias="apiVersion")
    ] = "networking.istio.io/v1alpha3"
    kind: Optional[Literal["EnvoyFilter"]] = "EnvoyFilter"
    metadata: Optional[apimachinery.ObjectMeta] = None
