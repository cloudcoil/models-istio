...
class ValidationMessage(BaseModel):
    ...
    type: Annotated[
        ...
        Field(title="cloudcoil.models.istio.telemetry.v1alpha1.MessageType"),
    ] = None
...
class Telemetry(Resource):
    class Builder(BaseModelBuilder):
        ...
        def api_version(self, value: Optional[Literal["telemetry.istio.io/v1alpha1"]], /) -> Self:
    ...
    api_version: Annotated[
        Optional[Literal["telemetry.istio.io/v1alpha1"]], Field(alias="apiVersion")
